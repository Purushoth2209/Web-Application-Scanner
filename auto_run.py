...
if __name__=="__main__":
    ...
    ap.add_argument("--noreferrer",action="store_true")   # ✅ add this line
    args=ap.parse_args()
    ...
    if args.noreferrer: cfg["optional"]["noreferrer"]=True   # ✅ pass it through
    ...
    if not cfg["actions"]:
        print("[!] Need at least one --add-post")
        exit(1)
